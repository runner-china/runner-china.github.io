...
网络调试当中经常需要用到一些命令行工具，其中较为著名的是[cURL](https://curl.haxx.se/)、[Wget](https://www.gnu.org/software/wget/)和[Netcat](http://nc110.sourceforge.net/)三款跨平台工具。它们除了具有对网络通信进行分析之类的常规功能，甚至还有数据爬取、端口反弹等特殊功能，完全是居家旅行必备之良品。本文对cURL、Wget和Netcat三款工具的常见功能进行介绍，方便新手快速掌握这些命令行工具的基本选项与参数。
